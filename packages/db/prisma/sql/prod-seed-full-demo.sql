...
INSERT INTO "timesheets" (
  ...
  "startTime", "endTime", "notes", "createdAt", "updatedAt"
) VALUES
  (
    ...
    '2026-07-07 08:00:00'::timestamp,
    '2026-07-07 12:30:00'::timestamp,
  ...
  (
    ...
    '2026-07-07 07:30:00'::timestamp,
    '2026-07-07 15:00:00'::timestamp,
    'Asamblare cadre',
    NOW(), NOW()
  ),
  (
    ...
    '2026-07-06 09:00:00'::timestamp,
    '2026-07-06 17:00:00'::timestamp,
    'Vopsire copertină',
    NOW(), NOW()
  ),
  (
    ...
    '2026-07-08 08:00:00'::timestamp,
    NULL,
    'Pontaj activ — debitare balustrade',
    NOW(), NOW()
  ),
  (
    ...
    '2026-07-05 10:00:00'::timestamp,
    '2026-07-05 14:00:00'::timestamp,
